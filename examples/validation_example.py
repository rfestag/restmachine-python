...
Requires: pip install rest-framework[validation]
"""
...
try:
    ...
    print("This example requires Pydantic. Install with: pip install rest-framework[validation]")
    exit(1)
...
@app.post('/users')
def create_user(validate_user_create: UserCreate, user_storage, next_id) -> UserResponse:
...
def update_user(validate_user_update: UserUpdate, user_exists, request: Request, user_storage) -> UserResponse:
